...
const TextNormalizer = (canal:string, string:any) => {
    ...
    if (canal == "Channel::Twilio::Whatsapp" || canal == "Channel::Sinch::Whatsapp" || canal == "Channel::Meta::Whatsapp") {
      _negrito = "*$1*";
      _italico = "_$1_";
      _enter = "\n";
    }
    ...
    return string.replace(negrito, _negrito).replace(italico, _italico).replace(enter, _enter);
};
